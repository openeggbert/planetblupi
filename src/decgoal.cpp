...
static short table_goal_build2[] =
{
	WM_ACTION_BUILD2,
		...
		GOAL_GOBLUPI,		+1,0, TRUE,
		GOAL_ACTION,		ACTION_PIOCHE, DIRECT_E,
		GOAL_PUTOBJECT,		-1,0, -1,-1,  // enlčve les planches
		GOAL_GOBLUPI,		-1,+1, TRUE,
		GOAL_ACTION,		ACTION_BUILDSEC, DIRECT_S,
		GOAL_GOBLUPI,		+1,0, TRUE,
		GOAL_ACTION,		ACTION_BUILDSEC, DIRECT_S,
...
static short table_goal_mur[] =
{
	WM_ACTION_MUR,
		...
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_PUTOBJECT,		0,0, -1,-1,  // enlčve les pierres
		GOAL_GOBLUPI,		+1,+1, TRUE,
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_ACTION,		ACTION_BUILDBREF, DIRECT_S,
...
static short table_goal_tour[] =
{
	WM_ACTION_TOUR,
		...
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_PUTOBJECT,		-1,0, -1,-1,  // enlčve les pierres
		GOAL_GOBLUPI,		0,+1, TRUE,
		GOAL_ACTION,		ACTION_BUILDBREF, DIRECT_O,
		GOAL_ACTION,		ACTION_PIOCHEPIERRE, DIRECT_E,
		GOAL_ACTION,		ACTION_BUILDBREF, DIRECT_O,
...
static short table_goal_palis[] =
{
	WM_ACTION_PALIS,
		...
		GOAL_GOBLUPI,		0,-1, TRUE,
		GOAL_ACTION,		ACTION_PIOCHE, DIRECT_E,
		GOAL_PUTOBJECT,		0,0, -1,-1,  // enlčve les planches
		GOAL_GOBLUPI,		+1,+1, TRUE,
		GOAL_ACTION,		ACTION_PIOCHESOURD, DIRECT_E,
		GOAL_ACTION,		ACTION_PIOCHESOURD, DIRECT_E,
		GOAL_ACTION,		ACTION_PIOCHESOURD, DIRECT_E,
...
// Blupi fait péter la dynamite trčs fort.
...
static short table_goal_bateaude[] =
{
	WM_ACTION_BATEAUDE,
		...
		GOAL_ACTION,		ACTION_STOP, DIRECT_E,
		GOAL_GROUP,			2,
		 GOAL_PUTOBJECT,	-1,-1, -1,-1,  // enlčve le bateau
...
// Le robot construit une usine ŕ araignées.
...
// Le robot construit une usine ŕ virus.
...
// Le robot construit une usine ŕ tracks.
...
// Le robot construit une usine ŕ bombe.
...
// Le robot construit une usine ŕ électro.
...
static short table_goal_mjeep[] =
{
	WM_ACTION_MJEEP,
		...
		GOAL_GROUP,			2,
		 GOAL_PUTOBJECT,	-1,-1, -1,-1,  // enlčve la jeep
...
static short table_goal_marmure[] =
{
	WM_ACTION_MARMURE,
		...
		GOAL_ACTION,		ACTION_STOP, DIRECT_E,
		GOAL_GROUP,			2,
		 GOAL_PUTOBJECT,	-1,-1, -1,-1,  // enlčve l'armure
...
// Blupi cherche oů planter des drapeaux.
...
// Blupi se prépare ŕ répéter une liste.
...
// Blupi se téléporte d'un endroit ŕ un autre.
...
// Retourne le pointeur ŕ la table table_goal_*.
...
short* GetTableGoal(int action)
{
	...
	while ( *ppTable != NULL )
	{
		if ( **ppTable == action )
		{
			return *ppTable+1;  // aprčs WM_ACTION_*
		}
