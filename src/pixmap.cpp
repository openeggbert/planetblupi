...
// alors qu'en mode fenętre, il faut chercher dans la
// palette systčme (obtenue avec InitSysPalette) !!!
...
// Dessine une partie d'image n'importe oů.
// Les modes sont 0=transparent, 1=opaque.
...
// Met ŕ jour le dessin de la souris.
...
void CPixmap::MouseUpdate()
{
	...
	MouseBackRestore();  // enlčve la souris dans m_lpDDSBack
...
// Enlčve la souris dans m_lpDDSBack.
