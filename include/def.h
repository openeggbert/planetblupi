...
#define DIMTEXTX		16		// dimensions max d'un caractčre
#define DIMTEXTY		16

#define DIMLITTLEX		16		// dimensions max d'un petit caractčre
...
#define ACTION_STOP			0		// arręt
#define ACTION_STOPf		1		// arręt fatigué
...
#define ACTION_TAKE			8		// fait sauter un objet sur la tęte (est)
#define ACTION_DEPOSE		9		// repose l'objet sur la tęte (est)
...
#define ACTION_STOPb		32		// arręt en bateau
#define ACTION_MARCHEb		33		// avance en bateau
#define ACTION_STOPj		34		// arręt en jeep
...
#define ACTION_BECHE		43		// blupi bčche
...
#define ACTION_STOPa		55		// arręt armure
...
#define ACTION_A_STOP		100		// araignée: arręt
...
#define ACTION_D_STOP		800		// disciple: arręt
...
#define ACTION_D_BECHE		810		// disciple: bčche
...
typedef struct
{
	...
	short	bHomeBlupi;		// blupi ŕ la maison
